...
//引入element-ui组件
import { Card, Loading, Rate,Form,FormItem,Input,Button,Dialog,Pagination,Carousel, CarouselItem,Message } from 'element-ui';
/*
 * 使用element-ui组件
 */
Vue.use(Loading);
...
new Vue({
  ...
  methods: {  
             ...
             //    }
             // },
             getOrderInfo(orderId) {console.log(123);
                        ...
                        LF.net.getJSON("/merchant/order/detail", params, res => {
                            if(res.code == "000") {
                               ...
                               console.log(this.orderInfo,this.orderDtlList);console.log(456);
                            }
                        }, function(xhr, type, errorThrown) {
                            console.log("error：" + type);
                            console.log("errorThrown：" + errorThrown);console.log(789);
                        });
             },       
        // choose:function(){
        //   for(var i = 1;i <= 10;i++){
